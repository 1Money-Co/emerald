...
## Emerald: MalachiteBFT for Ethereum execution clients via Engine API
...
(EL), with Engine API serving as the bridge between both. Emerald is a proof of concept
...
![malaketh-layered-0.png](css/assets/malaketh-layered-0.png)

It's worth noting that Emerald is not an Ethereum consensus client. Ethereum's consensus
...
Emerald is bringing instant finality to Ethereum execution but it cannot be used as a
...
Emerald is an application built on top of Malachite, which is unaware of Engine API and
...
<img src="css/assets/malaketh-layered-1.png" width="800" />

Emerald queries the execution client via the `eth_getBlockByNumber` RPC endpoint to fetch
...
<img src="css/assets/malaketh-layered-2.png" width="800" />
...
<img src="css/assets/malaketh-layered-3.png" width="800" />

---

## Performance evaluation

We deployed three nodes on a local network, each pairing a Emerald application with a Reth
